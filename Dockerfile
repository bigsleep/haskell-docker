...
RUN apt-get update && \
    ...
    apt-get install -y --no-install-recommends \
        ghc-8.6.1 alex-3.1.7 cabal-install-2.4 happy-1.19.5 \
...
ENV PATH /root/.cabal/bin:/root/.local/bin:/opt/cabal/2.4/bin:/opt/ghc/8.6.1/bin:/opt/happy/1.19.5/bin:/opt/alex/3.1.7/bin:$PATH
